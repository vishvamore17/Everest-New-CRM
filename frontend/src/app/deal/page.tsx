...
export default function LeadPage() {
    ...
    const fetchLeads = async () => {
        try {
            const response = await axios.get(
                "http://localhost:8000/api/v1/deal/getAllLeads"
            );
    ...
    const handleDeleteClick = async (lead: Lead) => {
        ...
        try {
            const response = await fetch(`http://localhost:8000/api/v1/deal/deleteLead/${lead._id}`, {
                method: "DELETE",
            });
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">Total {leads.length} deals</span>
